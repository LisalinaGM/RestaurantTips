  ...
  <div id="content">
    <section id="mainContent"> 
      <h1>Register Here!</h1>
		...
		<p> Your registration failed, try again with another email-address!</p>
		<form name = "inputForm" action="../processes/registrationProcess.php" onsubmit = "return validateForm()" method = "post">
